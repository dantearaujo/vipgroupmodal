(function (window, document) {
    function initVIPModal(config) {
        ...
        var defaultConfig = {
            ...
            expirationHours: 24 // New config for expiration time in hours
        };
        ...
        function createVIPAccessModal() {
            ...
            if (authData) {
                try {
                    ...
                    // If parsing fails, remove the item and continue
            ...
            function tryUnlock() {
                if (passwordInput.value === settings.vipPassword) {
                    ...
                    var authData = {
                        authenticated: true,
                        // Calculate expiration time (current time + configured hours in milliseconds)
        ...
        function checkAndInitializeVIPModal() {
            // Check if current path matches trigger path
...
initVIPModal({
    vipPassword: 'LINDA', // Change this to your VIP password
    groupLink: 'https://chat.whatsapp.com/KeKbyjZgp367i0CPlUORka', // Change to your group link
    triggerPath: '/grupo-vip', // Change to the path where you want the modal to appear
    lockImageUrl: 'https://agenciametodo.com/wp-content/uploads/cadeado.png', // Change to your lock image if needed
    expirationHours: 24 // Number of hours the authentication will remain valid
});